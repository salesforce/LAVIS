...
class Blip2Qformer(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        ...
        "coco": "configs/models/blip2_coco.yaml",
    }       
    def __init__(self, 
                 img_size = 224,
                 drop_path_rate = 0,
    ...
    def forward(self, samples):
        ...
        output_itm = self.Qformer.bert(text_ids_all,
        ...
        lm_output = self.Qformer(decoder_input_ids, 
    ...
    def generate(
        ...
        outputs = self.Qformer.generate(input_ids=input_ids,
    ...
    def compute_itm(self,image_inputs,text_ids,text_atts):
        ...
        output_itm = self.Qformer.bert(text_ids,
                                       query_embeds = query_tokens,
                                       attention_mask = attention_mask,
