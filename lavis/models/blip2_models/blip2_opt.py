...
class Blip2OPT(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_opt2.7b": "configs/models/blip2_pretrain_opt2.7b.yaml",
        "caption_coco_opt2.7b": "configs/models/blip2_caption_opt2.7b.yaml",
        "pretrain_opt6.7b": "configs/models/blip2_pretrain_opt6.7b.yaml",
        "caption_coco_opt6.7b": "configs/models/blip2_caption_opt6.7b.yaml",        
    }    
    def __init__(self, 
                 img_size = 224,
                 drop_path_rate = 0,
    ...
    def generate(
        ...
        outputs = self.opt_model.generate(input_ids = input_ids,
