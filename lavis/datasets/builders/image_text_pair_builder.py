...
from lavis.datasets.datasets.coyo_dataset import CoyoDataset
...
@registry.register_builder("coyo")
class CoyoBuilder(BaseDatasetBuilder):
    train_dataset_cls = CoyoDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/coyo/defaults_700m_capfilt.yaml"}
