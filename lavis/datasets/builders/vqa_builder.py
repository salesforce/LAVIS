...
from lavis.datasets.datasets.instruct_wrappers.coco_vqa_instruct_datasets import COCOVQAInstructDataset
...
class COCOVQAInstructBuilder(BaseInstructDatasetBuilder):
