        ...
        for split in splits:
            ...
            for url, storage_path in zip(urls, storage_paths):
                for each_url in url:
                    ...
                    build_info_path = os.path.join(build_info_dir, os.path.splitext(os.path.basename(each_url))[0] + '.build')
                    ...
                    # extracting
                    archive_path = os.path.join(dl_cache_dir, os.path.basename(each_url))
